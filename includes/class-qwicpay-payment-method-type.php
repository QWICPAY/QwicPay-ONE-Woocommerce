...
final class QwicPayPaymentMethodType extends AbstractPaymentMethodType {
    ...
    public function __construct() {
        ...
        // The parent AbstractPaymentMethodType does not have a constructor that needs calling,
        // but it's good practice to set $this->name here.

        //NOTE!!!!
        //Custom integrator:

        // Only hook this if you explicitly need to intercept the payment process from the block editor.
    }
    ...
    //         // $custom_data = $context->payment_data['myGatewayCustomData'] ?? null;
    //         // ... your custom processing logic here ...
    //         // If successful, set status and redirect:
